...
Поддомены:
- **Безопасность и доступ.** Управление пользователями: Регистрация, аутентификация и авторизация, настройка профиля.
- **Управление устройствами.** Подключение и управление различными устройствами(отопление, свет, ворота и т.д) по стандартным протоколам, добавление устройств в группы (помещения в доме).
- **Управление сценариями.** Создание сценариев с одним или несколькими устройствами в доме, в помещении.

Границы контекстов:
- **Безопасность и доступ.** Управление пользователями. Модели: пользователи (роли, права доступа опционально).
- **Управление устройствами.** Модели: устройства (свет, отопление, ворота), дом, помещение, телеметрия, команды.
- **Управление сценариями.** Создание сценариев с одним или несколькими устройствами в доме, в помещении.  Модели: сценарии, задачи, условия активации.
...
- **Сложность масштабирования:** Нагрузка на систему Управления устройствами будет кратно выше нагрузки на систему Безопасности и доступа и на систему Управление сценариями. Поэтому для эффективного распределения ресурсов нужно иметь возможность масштабировать эти системы отдельно. 
...
[Диаграмма контекста Умного дома](./schemas/smarthome_Context.puml)
![Диаграмма контекста Умного дома](./schemas/images/smarthome_Context.png)
